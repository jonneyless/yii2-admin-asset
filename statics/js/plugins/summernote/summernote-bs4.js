        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default().extend((jquery__WEBPACK_IMPORTED_MODULE_0___default().summernote.lang), {
          'en-US': {
            font: {
              ...
              unordered: 'Unordered list', ordered: 'Ordered list'
            }, options: {
              help: 'Help', fullscreen: 'Full Screen', codeview: 'Code View'
            }, paragraph: {
              paragraph: 'Paragraph',
              outdent: 'Outdent',
              indent: 'Indent',
  ...
  return {
    node: node, offset: offset
      ...
      function nextPointWithEmptyNode(point, isSkipInnerOffset) {
        var node, offset = 0; // if node is empty string node, return current node's sibling.
        ...
        if (nodeLength(point.node) === point.offset) {
          ...
          if (dom_isEmpty(node)) {
            if (!dom_isEmpty(point.node.nextSibling)) {
              return {
                node: point.node.nextSibling, offset: offset
              };
            }
            return null;
          }
...
function splitPoint(point, isInline) {
  ...
  var pivot = splitRoot && splitTree(splitRoot, point, {
    isSkipPaddingBlankHTML: isInline, isNotSplitEdgePoint: isInline
  }); // if container is point.node, find pivot with point.offset
  if (!pivot && container === point.node) {
    pivot = point.node.childNodes[point.offset];
  }
  return {
    rightNode: pivot, container: container
  };
}
...
function html($node, isNewlineOnBlock) {
  ...
  return markup;
      ...
      function posFromPlaceholder(placeholder) {
        ...
        return {
          left: pos.left, top: pos.top + height
        };
      }
  ...
  return node && !isText(node) && lists.contains(node.classList, 'note-styletag');
      ...
      var Context = /*#__PURE__*/function () {
        ...
        _createClass(Context, [{
          ...
          key: "code", value: function code(html) {
          ...
          key: "initializeModule", value: function initializeModule(key) {
          ...
          key: "module", value: function module(key, ModuleClass, withoutIntialize) {
          ...
          key: "removeModule", value: function removeModule(key) {
            var module = this.modules[key];
            if (module.shouldInitialize()) {
              if (module.events) {
          ...
          key: "memo", value: function memo(key, obj) {
            if (arguments.length === 1) {
          ...
          key: "removeMemo", value: function removeMemo(key) {
          ...
          key: "createInvokeHandler", value: function createInvokeHandler(namespace, value) {
            var _this4 = this;
            return function (event) {
          ...
          key: "invoke", value: function invoke() {
            var namespace = lists.head(arguments);
            var args = lists.tail(lists.from(arguments));
...
function pointToTextRange(point) {
  var textRangeInfo = function textRangeInfo(container, offset) {
    ...
    return {
      node: node, collapseToStart: isCollapseToStart, offset: offset
    };
  };
  ...
  return textRange;
      ...
      var WrappedRange = /*#__PURE__*/function () {
        ...
        range_createClass(WrappedRange, [{
          key: "nativeRange", value: function nativeRange() {
            if (env.isW3CRangeSupport) {
              ...
              var textRange = pointToTextRange({
                node: this.sc, offset: this.so
              });
              textRange.setEndPoint('EndToEnd', pointToTextRange({
                node: this.ec, offset: this.eo
              }));
              return textRange;
            }
          }
          ...
          key: "getPoints", value: function getPoints() {
            return {
              sc: this.sc, so: this.so, ec: this.ec, eo: this.eo
            };
          }
        }, {
          key: "getStartPoint", value: function getStartPoint() {
            return {
              node: this.sc, offset: this.so
            };
          }
        }, {
          key: "getEndPoint", value: function getEndPoint() {
            return {
              node: this.ec, offset: this.eo
            };
          }
          ...
          key: "scrollIntoView", value: function scrollIntoView(container) {
          ...
          key: "nodes", value: function nodes(pred, options) {
            pred = pred || func.ok;
          ...
          key: "commonAncestor", value: function commonAncestor() {
          ...
          key: "expand", value: function expand(pred) {
          ...
          key: "collapse", value: function collapse(isCollapseToStart) {
          ...
          key: "deleteContents", value: function deleteContents() {
            if (this.isCollapsed()) {
              return this;
            }
          ...
          key: "makeIsOn", value: function makeIsOn(pred) {
            return function () {
          ...
          key: "isLeftEdgeOf", value: function isLeftEdgeOf(pred) {
          ...
          key: "wrapBodyInlineWithPara", value: function wrapBodyInlineWithPara() {
          ...
          key: "insertNode", value: function insertNode(node) {
            var rng = this;
          ...
          key: "pasteHTML", value: function pasteHTML(markup) {
          ...
          key: "getWordRange", value: function getWordRange(findAfter) {
            var endPoint = this.getEndPoint();
          ...
          key: "getWordsRange", value: function getWordsRange(findAfter) {
            var endPoint = this.getEndPoint();
          ...
          key: "getWordsMatchRange", value: function getWordsMatchRange(regex) {
            var endPoint = this.getEndPoint();
            var startPoint = dom.prevPointUntil(endPoint, function (point) {
          ...
          key: "bookmark", value: function bookmark(editable) {
            return {
              s: {
                path: dom.makeOffsetPath(editable, this.sc), offset: this.so
              }, e: {
                path: dom.makeOffsetPath(editable, this.ec), offset: this.eo
              }
            };
          }
          /**
          ...
          key: "paraBookmark", value: function paraBookmark(paras) {
            return {
              s: {
                path: lists.tail(dom.makeOffsetPath(lists.head(paras), this.sc)), offset: this.so
              }, e: {
                path: lists.tail(dom.makeOffsetPath(lists.last(paras), this.ec)), offset: this.eo
              }
            };
          }
          /**
          ...
          key: "getClientRects", value: function getClientRects() {
            var nativeRng = this.nativeRange();
...
function createImage(url) {
  return external_jQuery_default().Deferred(function (deferred) {
    ...
    $img.one('load', function () {
      ...
      var History = /*#__PURE__*/function () {
        ...
        History_createClass(History, [{
          key: "makeSnapshot", value: function makeSnapshot() {
          ...
          key: "applySnapshot", value: function applySnapshot(snapshot) {
          ...
          key: "recordUndo", value: function recordUndo() {
      ...
      var Style = /*#__PURE__*/function () {
        ...
        Style_createClass(Style, [{
          ...
          key: "fromNode", value: function fromNode($node) {
          ...
          key: "stylePara", value: function stylePara(rng, styleInfo) {
          ...
          key: "styleNodes", value: function styleNodes(rng, options) {
            rng = rng.splitText();
          ...
          key: "current", value: function current(rng) {
      ...
      var Bullet = /*#__PURE__*/function () {
        ...
        Bullet_createClass(Bullet, [{
          ...
          key: "insertUnorderedList", value: function insertUnorderedList(editable) {
          ...
          key: "indent", value: function indent(editable) {
            var _this = this;
          ...
          key: "outdent", value: function outdent(editable) {
            var _this2 = this;
            var rng = range.create(editable).wrapBodyInlineWithPara();
            var paras = rng.nodes(dom.isPara, {
              includeAncestor: true
          ...
          key: "toggleList", value: function toggleList(listName, editable) {
            var _this3 = this;
            var rng = range.create(editable).wrapBodyInlineWithPara();
            var paras = rng.nodes(dom.isPara, {
              includeAncestor: true
          ...
          key: "wrapList", value: function wrapList(paras, listName) {
            var head = lists.head(paras);
          ...
          key: "releaseList", value: function releaseList(clustereds, isEscapseToBody) {
            var _this4 = this;
            var releasedParas = [];
            external_jQuery_default().each(clustereds, function (idx, paras) {
              var head = lists.head(paras);
          ...
          key: "appendToPrevious", value: function appendToPrevious(node) {
          ...
          key: "findList", value: function findList(node) {
          ...
          key: "findNextSiblings", value: function findNextSiblings(node) {
            var siblings = [];
      ...
      var Typing = /*#__PURE__*/function () {
        ...
        Typing_createClass(Typing, [{
          key: "insertTab", value: function insertTab(rng, tabsize) {
          ...
          key: "insertParagraph", value: function insertParagraph(editable, rng) {
      ...
      var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
        ...
        function getActionCell(virtualTableCellObj, resultAction, virtualRowPosition, virtualColPosition) {
          return {
            'baseCell': virtualTableCellObj.baseCell, 'action': resultAction, 'virtualTable': {
              'rowIndex': virtualRowPosition, 'cellIndex': virtualColPosition
            }
          };
        }
      ...
      var Table = /*#__PURE__*/function () {
        ...
        Table_createClass(Table, [{
          ...
          key: "addRow", value: function addRow(rng, position) {
            var cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
          ...
          key: "addCol", value: function addCol(rng, position) {
            var cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
    ...
    */
          ...
          key: "recoverAttributes", value: function recoverAttributes(el) {
            var resultStr = '';
            if (!el) {
              return resultStr;
            }
          ...
          key: "deleteRow", value: function deleteRow(rng) {
            var cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
            var row = external_jQuery_default()(cell).closest('tr');
          ...
          key: "deleteCol", value: function deleteCol(rng) {
            var cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
            var row = external_jQuery_default()(cell).closest('tr');
            var cellPos = row.children('td, th').index(external_jQuery_default()(cell));
          ...
          key: "createTable", value: function createTable(colCount, rowCount, options) {
            var tds = [];
            var tdHTML;
          ...
          key: "deleteTable", value: function deleteTable(rng) {
            var cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
      ...
      var Editor = /*#__PURE__*/function () {
          ...
          this.createLink = this.wrapCommand(function (linkInfo) {
            ...
            if (isTextChanged) {
              ...
              anchors = _this.style.styleNodes(rng, {
                nodeName: 'A', expandClosestSibling: true, onlyPartialContains: true
              });
            }
        ...
        Editor_createClass(Editor, [{
          ...
          key: "handleKeyMap", value: function handleKeyMap(event) {
          ...
          key: "preventDefaultEditableShortCuts", value: function preventDefaultEditableShortCuts(event) {
          ...
          key: "isLimited", value: function isLimited(pad, event) {
            pad = pad || 0;
          ...
          key: "createRange", value: function createRange() {
            this.focus();
            this.setLastRange();
          ...
          key: "createRangeFromList", value: function createRangeFromList(lst) {
          ...
          key: "setLastRange", value: function setLastRange(rng) {
            if (rng) {
              this.lastRange = rng;
            } else {
          ...
          key: "getLastRange", value: function getLastRange() {
            if (!this.lastRange) {
              this.setLastRange();
            }
          ...
          key: "saveRange", value: function saveRange(thenCollapse) {
            if (thenCollapse) {
          ...
          key: "restoreRange", value: function restoreRange() {
            if (this.lastRange) {
          ...
          key: "saveTarget", value: function saveTarget(node) {
          ...
          key: "restoreTarget", value: function restoreTarget() {
          ...
          key: "currentStyle", value: function currentStyle() {
          ...
          key: "styleFromNode", value: function styleFromNode($node) {
    ...
    */
          ...
          key: "beforeCommand", value: function beforeCommand() {
          ...
          key: "afterCommand", value: function afterCommand(isPreventTrigger) {
          ...
          key: "untab", value: function untab() {
            var rng = this.getLastRange();
            if (rng.isCollapsed() && rng.isOnCell()) {
          ...
          key: "wrapCommand", value: function wrapCommand(fn) {
            return function () {
              this.beforeCommand();
          ...
          key: "insertImage", value: function insertImage(src, param) {
            var _this3 = this;
          ...
          key: "insertImagesAsDataURL", value: function insertImagesAsDataURL(files) {
            var _this4 = this;
          ...
          key: "insertImagesOrCallback", value: function insertImagesOrCallback(files) {
          ...
          key: "getSelectedText", value: function getSelectedText() {
          ...
          key: "onFormatBlock", value: function onFormatBlock(tagName, $target) {
          ...
          key: "formatPara", value: function formatPara() {
            this.formatBlock('P');
          }
        }, {
          key: "fontStyling", value: function fontStyling(target, value) {
            var rng = this.getLastRange();
            if (rng !== '') {
          ...
          key: "getLinkInfo", value: function getLinkInfo() {
            var rng = this.getLastRange().expand(dom.isAnchor); // Get the first anchor on range(for edit).
            var $anchor = external_jQuery_default()(lists.head(rng.nodes(dom.isAnchor)));
            var linkInfo = {
              range: rng, text: rng.toString(), url: $anchor.length ? $anchor.attr('href') : ''
            }; // When anchor exists,
            if ($anchor.length) {
          ...
          key: "addRow", value: function addRow(position) {
          ...
          key: "addCol", value: function addCol(position) {
            var rng = this.getLastRange(this.$editable);
            if (rng.isCollapsed() && rng.isOnCell()) {
              this.beforeCommand();
          ...
          key: "deleteRow", value: function deleteRow() {
            var rng = this.getLastRange(this.$editable);
            if (rng.isCollapsed() && rng.isOnCell()) {
              this.beforeCommand();
          ...
          key: "deleteCol", value: function deleteCol() {
            var rng = this.getLastRange(this.$editable);
            if (rng.isCollapsed() && rng.isOnCell()) {
              this.beforeCommand();
          ...
          key: "resizeTo", value: function resizeTo(pos, $target, bKeepRatio) {
            var imageSize;
            if (bKeepRatio) {
              var newRatio = pos.y / pos.x;
              var ratio = $target.data('ratio');
              imageSize = {
                width: ratio > newRatio ? pos.x : pos.y / ratio, height: ratio > newRatio ? pos.x * ratio : pos.y
              };
            } else {
              imageSize = {
          ...
          key: "normalizeContent", value: function normalizeContent() {
      ...
      var Clipboard = /*#__PURE__*/function () {
        ...
        Clipboard_createClass(Clipboard, [{
          ...
          key: "pasteByEvent", value: function pasteByEvent(event) {
            var _this = this;
      ...
      var Dropzone = /*#__PURE__*/function () {
        ...
        Dropzone_createClass(Dropzone, [{
          ...
          key: "attachDragAndDropEvent", value: function attachDragAndDropEvent() {
            var _this = this;
      ...
      var CodeView = /*#__PURE__*/function () {
        ...
        Codeview_createClass(CodeView, [{
          key: "sync", value: function sync(html) {
          ...
          key: "purify", value: function purify(value) {
      ...
      var Fullscreen = /*#__PURE__*/function () {
        ...
        Fullscreen_createClass(Fullscreen, [{
          key: "resizeTo", value: function resizeTo(size) {
          ...
          key: "isFullscreen", value: function isFullscreen() {
      ...
      var Handle = /*#__PURE__*/function () {
        ...
        Handle_createClass(Handle, [{
              ...
              if (dom.isControlSizing(event.target)) {
                ...
                var onMouseMove = function onMouseMove(event) {
                  _this2.context.invoke('editor.resizeTo', {
                    x: event.clientX - posStart.left, y: event.clientY - (posStart.top - scrollTop)
          ...
          key: "update", value: function update(target, event) {
            ...
            if (isImage) {
              ...
              var imageSize = {
                w: $image.outerWidth(false), h: $image.outerHeight(false)
              };
              $selection.css({
                display: 'block', left: pos.left, top: pos.top, width: imageSize.w, height: imageSize.h
      ...
      var AutoLink = /*#__PURE__*/function () {
        ...
        AutoLink_createClass(AutoLink, [{
          ...
          key: "handleKeyup", value: function handleKeyup(e) {
            if (lists.contains([key.code.ENTER, key.code.SPACE], e.keyCode)) {
              this.replace();
            }
          }
      ...
      var AutoSync = /*#__PURE__*/function () {
        ...
        AutoSync_createClass(AutoSync, [{
          key: "shouldInitialize", value: function shouldInitialize() {
      ...
      var Buttons = /*#__PURE__*/function () {
        ...
        Buttons_createClass(Buttons, [{
          key: "representShortcut", value: function representShortcut(editorMethod) {
          ...
          key: "button", value: function button(o) {
          ...
          key: "isFontInstalled", value: function isFontInstalled(name) {
          ...
          key: "isFontDeservedToAdd", value: function isFontDeservedToAdd(name) {
            name = name.toLowerCase();
            return name !== '' && this.isFontInstalled(name) && env.genericFontFamilies.indexOf(name) === -1;
          }
        }, {
          key: "colorPalette", value: function colorPalette(className, tooltip, backColor, foreColor) {
            var _this = this;
                ...
                click: function click(e) {
                  ...
                  if (backColor && foreColor) {
                    _this.context.invoke('editor.color', {
                      backColor: $button.attr('data-backColor'), foreColor: $button.attr('data-foreColor')
                    });
                  } else if (backColor) {
                    _this.context.invoke('editor.color', {
          ...
          key: "addToolbarButtons", value: function addToolbarButtons() {
            var _this2 = this;
            ...
            this.context.memo('button.paragraph', function () {
              return _this2.ui.buttonGroup([_this2.button({
                ...
                className: 'note-align', children: [justifyLeft, justifyCenter, justifyRight, justifyFull]
              }), _this2.ui.buttonGroup({
                className: 'note-list', children: [outdent, indent]
              })])]).render();
            });
          ...
          key: "addImagePopoverButtons", value: function addImagePopoverButtons() {
            var _this3 = this;
            // Image Size Buttons
          ...
          key: "addLinkPopoverButtons", value: function addLinkPopoverButtons() {
            var _this4 = this;
          ...
          key: "addTablePopoverButtons", value: function addTablePopoverButtons() {
            var _this5 = this;
          ...
          key: "build", value: function build($container, groups) {
          ...
          key: "updateCurrentStyle", value: function updateCurrentStyle($container) {
          ...
          key: "updateBtnStates", value: function updateBtnStates($container, infos) {
            var _this6 = this;
          ...
          key: "tableMoveHandler", value: function tableMoveHandler(event) {
            var PX_PER_EM = 18;
            ...
            if (event.offsetX === undefined) {
              ...
              posOffset = {
                x: event.pageX - posCatcher.left, y: event.pageY - posCatcher.top
              };
            } else {
              posOffset = {
            ...
            var dim = {
              c: Math.ceil(posOffset.x / PX_PER_EM) || 1, r: Math.ceil(posOffset.y / PX_PER_EM) || 1
            };
            $highlighted.css({
      ...
      var Toolbar = /*#__PURE__*/function () {
        ...
        Toolbar_createClass(Toolbar, [{
          ...
          key: "followScroll", value: function followScroll() {
            ...
            if (!this.isFollowing && currentOffset > activateOffset && currentOffset < deactivateOffsetBottom - toolbarHeight) {
              ...
              this.$toolbar.css({
                position: 'fixed', top: otherBarHeight, width: editorWidth, zIndex: 1000
              });
          ...
          key: "changeContainer", value: function changeContainer(isFullscreen) {
            if (isFullscreen) {
          ...
          key: "updateFullscreen", value: function updateFullscreen(isFullscreen) {
            this.ui.toggleBtnActive(this.$toolbar.find('.btn-fullscreen'), isFullscreen);
            this.changeContainer(isFullscreen);
          }
        }, {
          key: "updateCodeview", value: function updateCodeview(isCodeview) {
          ...
          key: "activate", value: function activate(isIncludeCodeview) {
          ...
          key: "deactivate", value: function deactivate(isIncludeCodeview) {
            var $btn = this.$toolbar.find('button');
            if (!isIncludeCodeview) {
              $btn = $btn.not('.note-codeview-keep');
            }
        ...
        LinkDialog_createClass(LinkDialog, [{
          key: "initialize", value: function initialize() {
            ...
            var body = ['<div class="form-group note-form-group">', "<label for=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.textToDisplay, "</label>"), "<input id=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-link-text form-control note-form-control note-input\" type=\"text\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.url, "</label>"), "<input id=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-link-url form-control note-form-control note-input\" type=\"text\" value=\"http://\"/>"), '</div>', !this.options.disableLinkTarget ? external_jQuery_default()('<div></div>').append(this.ui.checkbox({
              className: 'sn-checkbox-open-in-new-window', text: this.lang.link.openInNewWindow, checked: true
            }).render()).html() : '', external_jQuery_default()('<div></div>').append(this.ui.checkbox({
              className: 'sn-checkbox-use-protocol', text: this.lang.link.useProtocol, checked: true
            }).render()).html()].join('');
          ...
          key: "bindEnterKey", value: function bindEnterKey($input, $btn) {
          ...
          key: "toggleLinkBtn", value: function toggleLinkBtn($linkBtn, $linkText, $linkUrl) {
          ...
          key: "showLinkDialog", value: function showLinkDialog(linkInfo) {
            var _this = this;
            return external_jQuery_default().Deferred(function (deferred) {
        ...
        LinkPopover_createClass(LinkPopover, [{
          ...
          key: "initialize", value: function initialize() {
            this.$popover = this.ui.popover({
              className: 'note-link-popover', callback: function callback($node) {
          ...
          key: "update", value: function update() {
            ...
            if (rng.isCollapsed() && rng.isOnAnchor()) {
              ...
              this.$popover.css({
                display: 'block', left: pos.left, top: pos.top
              });
            } else {
              this.hide();
            }
      ...
      var ImageDialog = /*#__PURE__*/function () {
        ...
        ImageDialog_createClass(ImageDialog, [{
          key: "initialize", value: function initialize() {
            ...
            this.$dialog = this.ui.dialog({
              title: this.lang.image.insert, fade: this.options.dialogsFade, body: body, footer: footer
            }).render().appendTo($container);
          }
        }, {
          key: "destroy", value: function destroy() {
          ...
          key: "showImageDialog", value: function showImageDialog() {
            var _this2 = this;
            return external_jQuery_default().Deferred(function (deferred) {
      ...
      var TablePopover = /*#__PURE__*/function () {
        ...
        TablePopover_createClass(TablePopover, [{
          ...
          key: "update", value: function update(target) {
            if (this.context.isDisabled()) {
              return false;
            }
      ...
      var VideoDialog = /*#__PURE__*/function () {
        ...
        VideoDialog_createClass(VideoDialog, [{
          key: "initialize", value: function initialize() {
            ...
            this.$dialog = this.ui.dialog({
              title: this.lang.video.insert, fade: this.options.dialogsFade, body: body, footer: footer
            }).render().appendTo($container);
          }
        }, {
          key: "destroy", value: function destroy() {
          ...
          key: "createVideoNode", value: function createVideoNode(url) {
          ...
          key: "showVideoDialog", value: function showVideoDialog() {
            var _this2 = this;
            return external_jQuery_default().Deferred(function (deferred) {
      ...
      var HelpDialog = /*#__PURE__*/function () {
        ...
        HelpDialog_createClass(HelpDialog, [{
            ...
            this.$dialog = this.ui.dialog({
              ...
              callback: function callback($node) {
                $node.find('.modal-body,.note-modal-body').css({
                  'max-height': 300, 'overflow': 'scroll'
                });
              }
            }).render().appendTo($container);
          }
          ...
          key: "createShortcutList", value: function createShortcutList() {
            var _this = this;
            var keyMap = this.options.keyMap[env.isMac ? 'mac' : 'pc'];
          ...
          key: "showHelpDialog", value: function showHelpDialog() {
            var _this2 = this;
            return external_jQuery_default().Deferred(function (deferred) {
              _this2.ui.onDialogShown(_this2.$dialog, function () {
                _this2.context.triggerEvent('dialog.shown');
      ...
      var AirPopover = /*#__PURE__*/function () {
        ...
        AirPopover_createClass(AirPopover, [{
          ...
          key: "update", value: function update(forcelyOpen) {
            var styleInfo = this.context.invoke('editor.currentStyle');
            if (styleInfo.range && (!styleInfo.range.isCollapsed() || forcelyOpen)) {
              var rect = {
                left: this.pageX, top: this.pageY
              };
              var containerOffset = external_jQuery_default()(this.options.container).offset();
      ...
      var HintPopover = /*#__PURE__*/function () {
        ...
        HintPopover_createClass(HintPopover, [{
          ...
          key: "initialize", value: function initialize() {
            ...
            this.$popover = this.ui.popover({
              className: 'note-hint-popover', hideArrow: true, direction: ''
            }).render().appendTo(this.options.container);
            this.$popover.hide();
          ...
          key: "moveDown", value: function moveDown() {
          ...
          key: "moveUp", value: function moveUp() {
            var $current = this.$content.find('.note-hint-item.active');
          ...
          key: "nodeFromItem", value: function nodeFromItem($item) {
          ...
          key: "createItemTemplates", value: function createItemTemplates(hintIdx, items) {
          ...
          key: "searchKeyword", value: function searchKeyword(index, keyword, callback) {
          ...
          key: "createGroup", value: function createGroup(idx, keyword) {
            var _this3 = this;
              ...
              if (this.hints.length && keyword) {
                ...
                if (bnd) {
                  ...
                  if (this.direction === 'top') {
                    this.$popover.css({
                      left: bnd.left, top: bnd.top - this.$popover.outerHeight() - POPOVER_DIST
                    });
                  } else {
                    this.$popover.css({
                      left: bnd.left, top: bnd.top + bnd.height + POPOVER_DIST
                    });
                  }
                }
              } else {
      ...
      (external_jQuery_default()).summernote = external_jQuery_default().extend((external_jQuery_default()).summernote, {
        version: '0.8.20', plugins: {}, dom: dom, range: range, lists: lists, options: {
          ...
          modules: {
            ...
            'handle': Handle, // FIXME: HintPopover must be front of autolink
          ...
          placeholder: null,
          inheritPlaceholder: false, // TODO: need to be documented
          recordEveryKeystroke: false,
          historyLimit: 200, // TODO: need to be documented
          showDomainOnlyForAutolink: false, // TODO: need to be documented
          hintMode: 'word',
          hintSelect: 'after',
          ...
          fontSizeUnits: ['px', 'pt'], // pallete colors(n x n)
          ...
          colorButton: {
            foreColor: '#000000', backColor: '#ffff00'
          },
      ...
      var Renderer = /*#__PURE__*/function () {
        ...
        renderer_createClass(Renderer, [{
          key: "render", value: function render($parent) {
            ...
            return renderer.create('<div class="note-color-palette"></div>', function ($node, options) {
              ...
              if (options.tooltip) {
                $node.find('.note-color-btn').tooltip({
                  container: options.container || editorOptions.container, trigger: 'hover', placement: 'bottom'
                });
              }
            })($node, options);
          },
          button: function button($node, options) {
            return renderer.create('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1"></button>', function ($node, options) {
              if (options && options.tooltip) {
                $node.attr({
                  title: options.tooltip, 'aria-label': options.tooltip
                }).tooltip({
                  container: options.container || editorOptions.container, trigger: 'hover', placement: 'bottom'
                }).on('click', function (e) {
